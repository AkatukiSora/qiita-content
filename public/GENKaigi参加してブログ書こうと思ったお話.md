...
私がこのセッションから受け取った主張は、ざっくり以下の通りです。
...
本質を含むキャッチフレーズを決めて何度も叫ぶと、こうなるんだという学びになりました。
それと同時に、次の行動を起こさせるためにTODOリストへ入れさせたりしていたので、こういう手段もあるんだなと驚きました。  
ここは次回から実践したい。
...
入って最初、目に留まったのは展示ブース...ではなく、さくらインターネットさんが展示用に置いているサーバーラックでした。一部稼働中で、めちゃくちゃ静かでした。
